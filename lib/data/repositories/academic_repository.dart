...
abstract class AcademicRepository {
  // Classes
  Future<PaginatedResponse<ClassModel>> getClasses({int page = 1, String? search});
  ...
  // Students
  Future<PaginatedResponse<StudentModel>> getStudents({int page = 1, String? classId, String? search});
  ...
  // Teachers
  Future<PaginatedResponse<TeacherModel>> getTeachers({int page = 1, String? search});
  Future<TeacherModel> getTeacherById(String id);

  // Announcements
  Future<PaginatedResponse<Map<String, dynamic>>> getAnnouncements({int page = 1});
  Future<Map<String, dynamic>> createAnnouncement(Map<String, dynamic> data);

  // Schedules
  Future<List<Map<String, dynamic>>> getSchedules({String? classId, String? teacherId});

  // Letters
  Future<PaginatedResponse<Map<String, dynamic>>> getLetters({int page = 1});
}
