...
class PklLocationReportScreen extends StatefulWidget {
  ...
  @override
  State<PklLocationReportScreen> createState() => _PklLocationReportScreenState();
}
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      if (_foto != null) {
        ...
        final fileName = _foto!.name.isNotEmpty ? _foto!.name : 'foto_lokasi.jpg';
        fdMap['foto'] = MultipartFile.fromBytes(bytes, filename: fileName);
      }
