...
class AbsensiPramukaScreen extends StatefulWidget {
  const AbsensiPramukaScreen({super.key});

  @override
  State<AbsensiPramukaScreen> createState() => _AbsensiPramukaScreenState();
}

class _AbsensiPramukaScreenState extends State<AbsensiPramukaScreen>
    with SingleTickerProviderStateMixin {
  late final _AbsensiPramukaController _ctrl;
  ...
  void initState() {
    ...
    _ctrl = _AbsensiPramukaController(
...
class _AbsensiPramukaController extends ChangeNotifier {
  final VocationalService service;

  _AbsensiPramukaController({required this.service});
...
class _InputTab extends StatefulWidget {
  final _AbsensiPramukaController ctrl;
  final bool isDark;
                  ...
                  return Padding(
                    ...
                    child: Row(
                      children: [
                        SizedBox(
                          width: 28,
                          child: Text('${i + 1}', style: TextStyle(fontSize: 11, color: isDark ? Colors.white38 : Colors.grey[400])),
                        ),
                        Expanded(
                          flex: 3,
                          child: Text(
