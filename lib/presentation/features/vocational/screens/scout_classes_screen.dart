                      ...
                      Padding(
                        ...
                        child: Center(
                          child: Column(children: [
                            ...
                            Text('Belum ada silabus yang diupload', style: TextStyle(color: isDark ? Colors.white38 : Colors.grey[400])),
                          ]),
                        ),
                      )
                    else
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(item['judul_kegiatan'] ?? '-',
                                ...
                                Row(
                                  children: [
                                    if (item['file_nama'] != null) ...[
                                      _ActionBtn(label: '⬇ Unduh', color: const Color(0xFF16A34A), bg: const Color(0xFFDCFCE7), onTap: () => _download(item)),
                                      const SizedBox(width: 8),
                                    ],
                                    _ActionBtn(label: '🗑 Hapus', color: const Color(0xFFDC2626), bg: const Color(0xFFFFEBEB), onTap: () => _hapus(item)),
                                  ],
                                ),
                              ],
                            ),
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          onChanged: (v) {
            ...
            setState(() { _kelasId = v ?? ''; _namaKelas = kelas['nama_kelas'] ?? ''; });
          },
        ),
      ),
    );
  ...
  Widget _dateField(bool isDark, Color border) {
    return GestureDetector(
      onTap: () async {
        ...
        if (picked != null) setState(() => _tanggal = '${picked.year}-${picked.month.toString().padLeft(2, '0')}-${picked.day.toString().padLeft(2, '0')}');
      },
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 12),
        decoration: BoxDecoration(
