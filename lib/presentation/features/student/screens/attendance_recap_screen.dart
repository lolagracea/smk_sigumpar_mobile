...
class _StudentAttendanceInputView extends StatefulWidget {
  ...
  @override
  State<_StudentAttendanceInputView> createState() =>
      _StudentAttendanceInputViewState();
}

class _StudentAttendanceInputViewState
    extends State<_StudentAttendanceInputView> {
