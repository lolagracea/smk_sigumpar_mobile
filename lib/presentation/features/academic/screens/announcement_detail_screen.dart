...
class _AnnouncementDetailScreenState extends State<AnnouncementDetailScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      final idAsInt = int.tryParse(widget.announcementId) ?? 0;
      if (provider.selectedAnnouncement == null ||
          provider.selectedAnnouncement!.id != idAsInt) {
        provider.selectAnnouncement(idAsInt);
      }
    });
  }
            ...
            ElevatedButton.icon(
              onPressed: () {
                context
                    ...
                    .selectAnnouncement(int.tryParse(widget.announcementId) ?? 0);
              },
