...
class _HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      // Sesuaikan background indicator
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildAnnouncementCard(context, academicProvider, isDark),
          ],
        ),
      ),
    );
  ...
  BoxDecoration _cardDecoration(bool isDark) {
    return BoxDecoration(
      // Kartu berwarna gelap di dark mode, putih di light mode
      color: isDark ? const Color(0xFF1E293B) : Colors.white,
      borderRadius: BorderRadius.circular(16),
      boxShadow: [
        BoxShadow(
          // Shadow lebih tebal sedikit untuk mode gelap agar terlihat memisah dari background
