...
import '../../presentation/features/academic/screens/attendance_recap_screen.dart';
import '../../presentation/features/academic/screens/grade_recap_screen.dart';
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            builder: (_, __) => const RekapNilaiScreen(),
          ),
