...
import '../../presentation/features/vocational/screens/add_pkl_location_screen.dart';
import '../../presentation/features/vocational/screens/add_pkl_progress_screen.dart';
import '../../presentation/features/vocational/screens/pkl_grade_report_screen.dart';
import '../../presentation/features/vocational/screens/add_pkl_grade_screen.dart';
    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: RouteNames.addPklLocation,
            builder: (_, __) => const AddPklLocationScreen(),
          ),
          GoRoute(
          ...
          GoRoute(
            path: RouteNames.addPklProgress,
            builder: (_, __) => const AddPklProgressScreen(),
          ),
          GoRoute(
            path: RouteNames.pklGradeReport,
            builder: (_, __) => const PklGradeReportScreen(),
          ),
          GoRoute(
            path: RouteNames.addPklGrade,
            builder: (_, __) => const AddPklGradeScreen(),
          ),
